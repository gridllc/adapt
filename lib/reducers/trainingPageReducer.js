...
exports.trainingPageReducer = exports.initialTrainingPageState = void 0;
exports.initialTrainingPageState = {
    activeTab: 'steps',
 ...
 */
function trainingPageReducer(state, action) {
    switch (action.type) {
        case 'SET_ACTIVE_TAB':
...
exports.trainingPageReducer = trainingPageReducer;
