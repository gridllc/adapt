...
exports.cancel = exports.speak = void 0;
const voiceMap_1 = require("@/utils/voiceMap");
...
const _generateSpeechFn = (0, functions_1.httpsCallable)(firebase_1.functions, 'generateSpeech');
/**
 ...
 */
const speakWithFallbackApi = (text) => {
    return new Promise((resolve) => {
 ...
 */
async function speak(text, character = 'system') {
    const voiceId = (0, voiceMap_1.getVoiceIdForCharacter)(character);
