...
exports.getPromptContextForLiveCoach = exports.getCelebratoryTagline = exports.getTagline = void 0;
// --- Tagline Management ---
const TAGLINES = [
 ...
 */
const getCelebratoryTagline = () => {
    return CELEBRATORY_TAGLINES[Math.floor(Math.random() * CELEBRATORY_TAGLINES.length)];
};
exports.getCelebratoryTagline = getCelebratoryTagline;
// --- Prompt Construction ---
/**
 ...
 */
const getPromptContextForLiveCoach = (stepTitle, requiredItems, contextType, pastFeedback, similarFixes, userQuery) => {
...
exports.getPromptContextForLiveCoach = getPromptContextForLiveCoach;
