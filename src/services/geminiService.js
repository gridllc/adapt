 ...
 */
export const getTranscriptWithConfidence = async (videoFile) => {
 ...
 * @returns A promise that resolves to the generated module data.
 */
export const generateModuleFromModelNumber = async (brand, model) => {
    if (import.meta.env.DEV)
 ...
 */
export const detectIntent = async (userQuestion) => {
    if (import.meta.env.DEV)
 ...
 */
export const startChat = (stepsContext, fullTranscript, history = [], templateContext) => {
    const ai = getAiClient();
 ...
 */
export async function sendMessageWithRetry(chat, prompt, retries = 2) {
 ...
 */
export const getFallbackResponse = async (prompt, history, stepsContext, fullTranscript) => {
    if (import.meta.env.DEV)
 ...
 */
export const generatePerformanceSummary = async (moduleTitle, unclearSteps, userQuestions) => {
    if (import.meta.env.DEV)
 ...
 */
export const evaluateCheckpointAnswer = async (step, answer) => {
    if (import.meta.env.DEV)
 ...
 */
export const generateBranchModule = async (stepTitle, questions) => {
    if (import.meta.env.DEV)
