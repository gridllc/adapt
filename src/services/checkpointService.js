...
const _logCheckpointResponseFn = httpsCallable(functions, 'logCheckpointResponse');
const _getCheckpointResponsesForModuleFn = httpsCallable(functions, 'getCheckpointResponsesForModule');
const _getCheckpointFailureStatsFn = httpsCallable(functions, 'getCheckpointFailureStats');
/**
 ...
 */
export async function logCheckpointResponse(response) {
    try {
 ...
 */
export async function getCheckpointResponsesForModule(moduleId) {
    try {
 ...
 */
export async function getCheckpointFailureStats(moduleId) {
    try {
