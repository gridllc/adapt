...
export const getSession = async (moduleId, sessionToken) => {
    try {
...
export const getSessionSummary = async (moduleId, sessionToken) => {
...
export const getTotalSessionCount = async () => {
    return authedApiFetch('/sessions/count/total');
};
export const getCompletedSessionCount = async () => {
    return authedApiFetch('/sessions/count/completed');
};
