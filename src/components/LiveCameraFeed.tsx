...
export const LiveCameraFeed = forwardRef<HTMLVideoElement, LiveCameraFeedProps>(
  ({ instruction, onClick, detectedObjects }, ref) => {
    ...
    return (
      <div
        className="relative w-full h-full bg-slate-900 rounded-lg overflow-hidden shadow-xl border border-slate-700 cursor-pointer"
        onClick={onClick}
      >
        <video
          ref={ref}
          ...
          style={{ transform: 'scaleX(1)' }} // Force un-mirrored video
        />
